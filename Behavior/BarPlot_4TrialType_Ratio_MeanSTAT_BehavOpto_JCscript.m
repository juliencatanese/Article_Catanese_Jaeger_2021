...
cor=[]; coro=[]; 
CRvsCL=[]; CRovsCLo =[]; impRvsimpL = [];impRovsimpLo = []; erPRvserPL = []; erPRovserPLo = [];
...
set(gca,...
    'Ylim',[-10 10], ... 
    'Xlim',[pos(1)-0.25 pos(3)+0.25],...
    'Xtick',[pos(1) pos(2) pos(3)],...
    'XTickLabel',{'Correct', 'errorSide', 'impulse'} );
