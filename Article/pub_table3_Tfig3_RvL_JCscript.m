...
if parfig.saveTABLE ==1
    ...
    % Tfig3_RvL = (old TcLvcR)    
    Tfig3_RvL = addvars(T1, SMA_MAX_Hz_cont, SMA_MIN_Hz_cont, SMA_MAX_Hz_ipsi, SMA_MIN_Hz_ipsi,...
    ...
    save('listcell.mat','Tfig3_RvL', '-append')
    disp('Tfig3_RvL SAVED'); Tfig3_RvL(1,:)
