...
Tfig1_VMopto = Tfig1_VMopto(Tfig5_imp.ncell,:); 

for nc= 1:max(size(Tfig1_VMopto.ncell))
...
X1= Tfig1_VMopto.AP(logical(Tfig1_VMopto.VMVL & Tfig5_imp.dzoc_inib_delAll));
Y1= Tfig1_VMopto.ML(logical(Tfig1_VMopto.VMVL & Tfig5_imp.dzoc_inib_delAll));
Z1= Tfig1_VMopto.DV(logical(Tfig1_VMopto.VMVL & Tfig5_imp.dzoc_inib_delAll));

X2= Tfig1_VMopto.AP(logical(Tfig1_VMopto.VMVL & Tfig5_imp.dzic_exct_delAll));
Y2= Tfig1_VMopto.ML(logical(Tfig1_VMopto.VMVL & Tfig5_imp.dzic_exct_delAll));
Z2= Tfig1_VMopto.DV(logical(Tfig1_VMopto.VMVL & Tfig5_imp.dzic_exct_delAll));
...
ylabel('ML')
zlabel('DV')
legend ('omi','imp', 'VM', 'VAL')

saveas(gcf, [SaveFolder '\S6A.fig'])
saveas(gcf, [SaveFolder '\S6A.png'])
saveas(gcf, [SaveFolder '\S6A.emf'])

% Distrib and stats 
disp('AP')
[Px1 Hx1] = ranksum(X1,X2); if Hx1; Px1, end  %p=0.0368
disp('ML')
[Py1 Hy1] = ranksum(Y1,Y2); if Hy1; Py1, end
disp('DV')
[Pz1 Hz1] = ranksum(Z1,Z2); if Hz1; Pz1, end  %p=0.0047
...
saveas(gcf, [SaveFolder '\S6B.fig'])
saveas(gcf, [SaveFolder '\S6B.png'])
saveas(gcf, [SaveFolder '\S6B.emf'])
