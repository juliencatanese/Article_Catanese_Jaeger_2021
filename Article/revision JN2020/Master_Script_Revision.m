...
%% Figure1 Video Analysis
% Plot_DLC_AverageAcrossMice

%% Figure2 cells quality
Get_refractory
Get_SpkWave
...
%% FIGURE 3 RASTER-SRF examples:   
SAVEFOLDER = 'C:\Users\catan\Dropbox\Article_JNeuro_Julien_Dieter\REVISION\figure ephys\RASTER cor FIG3\'
% Cell#15 TRIPLE (Mouse#1)
CellNum = 15;
cd('D:\DATA EMORY\JC_Analysis\JCVGAT11\vgat11_w10d4_z4300_VM_taskonly_nonepost_CC4F_180505_vidY_150tr_40cel_00mW');
MouseID =  'vgat11w10d4';
CellID='S2Ch7clu1'; Sh=str2num(CellID(2));Ch=str2num(CellID(5)); CLUST=str2num(CellID(9));
psth_trial_type={'cor'}; col={'k'};
pre=2250; post=1750; 
K=2;  
GaussSmooth=75;
...
legend( [ 'cell #' num2str(CellNum)],'LineWidth',2, 'Location', 'northeast');
saveas(gcf, [SAVEFOLDER 'Average_SDF_Example_CellSh' num2str(Sh) 'Ch' num2str(Ch) 'clu'  num2str(CLUST) '_'  psth_center_evt],'png')
saveas(gcf, [SAVEFOLDER 'Average_SDF_Example_CellSh' num2str(Sh) 'Ch' num2str(Ch) 'clu'  num2str(CLUST) '_'  psth_center_evt],'emf')

% Cell#39 UNI Type2 (Mouse#1)
CellNum = 39;
cd('D:\DATA EMORY\JC_Analysis\JCVGAT11\vgat11_w10d4_z4300_VM_taskonly_nonepost_CC4F_180505_vidY_150tr_40cel_00mW');
MouseID =  'vgat11w10d4';
CellID='S4Ch6clu1'; Sh=str2num(CellID(2));Ch=str2num(CellID(5)); CLUST=str2num(CellID(9));
psth_trial_type={'cor'}; col={'k'};
pre=2250; post=1750; 
K=2;  
GaussSmooth=75;
...
% Cell#398 UNI Type3 (Mouse#5)
CellNum = 398;
cd('D:\DATA EMORY\JC_Analysis\JCVGAT17\vgat17_w10d4_z4200_VM_taskopto_optopost_CCAE_180726_vidY_075tr_41cel_10mW_bl_4otr');
MouseID =  'vgat11w10d4';
CellID='S3Ch4clu1'; Sh=str2num(CellID(2));Ch=str2num(CellID(5)); CLUST=str2num(CellID(9));
psth_trial_type={'cor'}; col={'k'};
pre=2250; post=1750; K=1;  
GaussSmooth=75;
psth_center_evt='GoCue';
pub_SDF_Raster_1cell_ShadedSEM_JCfun(Sh, Ch, CLUST, psth_center_evt , psth_trial_type, K, col, pre, post, GaussSmooth)
legend( [ 'cell #' num2str(CellNum)],'LineWidth',2, 'Location', 'northeast');
...
% Cell#49 UNI Type1 (Mouse#2) VM
CellNum = 49;
cd('D:\DATA EMORY\JC_Analysis\JCVGAT12\vgat12_w11d5_z4300_VM_taskopto_optopost_CCAE_180609_vidY_100tr_42cel_10mW_3otr');
MouseID =  'vgat12w11d5';
CellID='S2Ch4clu1'; Sh=str2num(CellID(2));Ch=str2num(CellID(5)); CLUST=str2num(CellID(9));
psth_trial_type={'cor'}; col={'k'};
pre=2250; post=1750; K=1;  
GaussSmooth=75;
psth_center_evt='GoCue';
...
% Cell#273 UNI Type1 (Mouse#4) VM
CellNum = 273;
cd('D:\DATA EMORY\JC_Analysis\JCVGAT15\vgat15_w10d3_z4250_VM_taskonly_nonepost_CAED_180717_vidY_150tr_37cel_00mW');
MouseID =  'vgat15w10d3';
CellID='S4Ch4clu1'; Sh=str2num(CellID(2));Ch=str2num(CellID(5)); CLUST=str2num(CellID(9));
psth_trial_type={'cor'}; col={'k'};
pre=2250; post=1750; K=1;  
GaussSmooth=75;
psth_center_evt='GoCue';
...
% Cell#156 DOUBLE RAMP Type2-3 (Mouse#3) VM *** very good
CellNum = 156;
cd('D:\DATA EMORY\JC_Analysis\JCVGAT14\vgat14_w14d7_z4350_VM_taskonly_nonepost_CC4F_180714_vidN_075tr_40cel_00mW_pre_drift');
MouseID =  'vgat14w14d7';
CellID='S1Ch4clu2'; Sh=str2num(CellID(2));Ch=str2num(CellID(5)); CLUST=str2num(CellID(9));
psth_trial_type={'cor'}; col={'k'};
pre=2250; post=1750; K=1;  
GaussSmooth=75;
psth_center_evt='GoCue';
...
%% Cell#284 UNI1 AIR PUFF Type1 (Mouse#3) VAL 
CellNum = 284;
cd('D:\DATA EMORY\JC_Analysis\JCVGAT15\vgat15_w10d7_z4400_VM_taskopto_optopost_G912_180721_vidY_250tr_24cel_11mW');
MouseID =  'vgat15w10d7';
CellID='S1Ch2clu1'; Sh=str2num(CellID(2));Ch=str2num(CellID(5)); CLUST=str2num(CellID(9));
psth_trial_type={'cor'}; col={'k'};
pre=2250; post=1750; K=1;  
GaussSmooth=75;
psth_center_evt='GoCue';
...
%% Cell#109 UNI1 AIR PUFF Type1 (Mouse#3) VAL 
CellNum = 109;
cd('D:\DATA EMORY\JC_Analysis\JCVGAT14\vgat14_w14d2_z4670_VM_taskopto_optopost_G912_180709_vidY_100tr_29cel_10mW');
MouseID =  'vgat14w14d2';
CellID='S2Ch1clu1'; Sh=str2num(CellID(2));Ch=str2num(CellID(5)); CLUST=str2num(CellID(9));
psth_trial_type={'cor'}; col={'k'};
pre=2250; post=1750; K=1;  
GaussSmooth=75;
psth_center_evt='GoCue';
...
pub_SDF_Raster_1cell_ShadedSEM_JCfun(Sh, Ch, CLUST, psth_center_evt , psth_trial_type, K, col, pre, post, GaussSmooth)
legend(['cellID=' num2str(CellNum)], ['SEM=' num2str(K)])
...
%% Figure5 MULTI-CELL SINGLE TRIALS FIGURE (7cells in 5cor, 2imp, 2omi trials )
...
parfig.center_evt = 'Licks';% center ('Delay' ; 'GoCue' ;'APuff'; 'Licks')
parfig.epoch = 'delay'
...
% close all
SaveFigFolder = 'C:\Users\catan\Documents\EMORY\ARTICLE_JC_DJ\Fig7_classifier'
clearvars -except mypath parfig Tfig1_VMopto listcell SaveFigFolder jjs
...
for ii=1:2
    if ii==1
        ...
        parfig.minNbcell = 20;
        if parfig.center_evt == 'Gocue'; col = 'r'; else; col = 'b'; end
    elseif ii==2
        celltype = 'ShuffleControl'; LegendName{ii} = celltype;
        parfig.minNbcell = 20;
        if parfig.center_evt == 'Gocue'; col = 'k'; else; col = 'y'; end
    elseif ii==3
    ...
    for jj=1:1
        ...
        if ii==1
            legend(LegendName{1})
        elseif ii==2
            legend(LegendName{1}, '', LegendName{2}')
        elseif ii==3
