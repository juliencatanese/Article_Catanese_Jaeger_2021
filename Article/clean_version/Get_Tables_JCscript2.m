...
parfig.BaselineEpoch= [150:2150]; % Baseline time 2sec before trial start
parfig.pre = parfig.BaselineEpoch(end) + 1500 % define how much time before zero (GoCue here)
