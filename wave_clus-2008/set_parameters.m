...
par.tmax= 10360;                      % maximum time to load (in sec) 
par.tmin= 10000;                         % starting time for loading (in sec) 
...
par.detect_fmax = 8000;              % low pass filter for detection (default 1000) 
