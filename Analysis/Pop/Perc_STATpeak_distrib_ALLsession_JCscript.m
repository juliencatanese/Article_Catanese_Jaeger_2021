...
% Plot the Distribution of cells with Activity increases above 3sem from baseline.  
% see Fig2C in Article JC&DJ. 
% dependency:  SDF_mean_sem_Baseline_mlibJCscript
