function [SMA SSA SSema Sig_idx BarSig] = Distrib_stat_sdf_JCfun_v2(pre, post, psth_trig_evt, psth_trial_type, col, setplot)
...
for ns=1:NSess
    ...
    for nchan = 1:ncluf %  channel loop
        ...
        for CLUST= 1:Nclust %Cluster loop within each channel
            ...
            [Sig_idx, BarSig] = Select_sigCell_1std_JCfun_v2(sdf_mean, sdf_std, Sig_idx, BarSig, pre, post, ncell)        end;
    end
end
