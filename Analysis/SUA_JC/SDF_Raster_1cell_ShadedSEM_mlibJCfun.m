function SDF_Raster_1cell_ShadedSEM_mlibJCfun(Sh, Ch, CLUST, psth_trig_evt , psth_trial_type, K, col, pre, post, GaussSmooth)
% function SDF_Raster_1cell_mlibJCfun(Sh, Ch, CLUST, psth_trig_evt , psth_trial_type, col, pre, post, GaussSmooth)
