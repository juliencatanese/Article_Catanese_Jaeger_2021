...
%%
Plot_SDFshaded_JCfun(SMA1, SSemA1,  cell2plot, parfig, 1)
Plot_Raster_JCfun(SMA1, SSA1, spxtimes, trigtimes, cell2plot, parfig, 1)
Plot_Raster_SDFshaded_JCfun(SMA1, SSemA1, spxtimes, trigtimes, cell2plot, parfig)
%%
sublist = {'vgat17w10d4z4200S3Ch1clu#1'}
cell2plot = listcell(sublist,:);
...
Plot_Raster_SDFshaded_JCfun(SMA1, SSemA1, spxtimes, trigtimes, cell2plot, parfig)
%%
Plot_Raster_SDFshaded_JCfun(SMA1, SSA1, spxtimes, trigtimes, cell2plot, parfig)
% SUA Example#2: Type2 = Delay Epoch
sublist = {'vgat14w14d2z4670S1Ch6clu#2'}
cell2plot = listcell(sublist,:);
